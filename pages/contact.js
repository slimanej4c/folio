       ...
       <div className='contact-page'  >
        <motion.div className='contact-all'  variants={formVariants}
                 ...
                 whileInView='visible' style={{height:"100%",width:"100%"}}>
                    ...
                    <li> <FontAwesomeIcon icon={faPhone}  className="contact-icon"/> +213 696 89 13 19</li>
                    <li> <FontAwesomeIcon icon={faEnvelope}  className="contact-icon"/> slimaneetude@gmail.com</li>
                    ...
                    Slimane Ben
                      ...
                      <a href="https://comeup.com/fr/@pour-dev" target="_blank" rel="noopener noreferrer"> 
